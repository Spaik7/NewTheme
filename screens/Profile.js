          ...
          <TouchableOpacity
            ...
            onPress={() => {
              if (index === 0) {
                ...
                navigation.navigate('Messanger', { email, page: 2 });
              } else if (index === 2) {
                navigation.navigate('Home Page', { email });
              } else if (index === 3) {
                navigation.navigate('QandA', { email, page: 2 });
              }
            }}
          >
            {index === 0 ? (
        ...
        {[...Array(10)].map((_, index) => (
            <View key={index} style={styles.listItem2}>
                <Image
                    ...
                    style={styles.immagine2}
                    resizeMode="contain"
                />
                {/* Text Container */}
                <View style={styles.textContainer2}>
                    <Text style={styles.listItemText2}>Friend {index + 1}</Text>
                    <Text style={styles.listItemSubtext2}>Additional Info</Text>
                </View>
                <MaterialCommunityIcons name="information-outline" size={24} color="#000" />
            </View>
        ))}
